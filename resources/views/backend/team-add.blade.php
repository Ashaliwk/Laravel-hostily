            ...
            <div class="container-fluid">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <a href="{{url('/admin/team')}}"><button class="btn btn-success">Team Member List</button></a></a>
                    </div>
                    <div class="card-body">
                        <form method="post" action="/admin/team-add" enctype="multipart/form-data">
                            ...
                            <div class="form-floating mb-3">
                                <label for="printerest">Printerest</label>
                                <input class="form-control" id="printerest" type="text" placeholder="Enter printerest Profile" name="printerest" value="{{old('printerest')}}">
                                @if ($errors->has('printerest'))
                                    <span class="text-danger">
                                        {{$errors->first('printerest')}}
                                    </span>
                                @endif
                            </div>
                            <div class="form-floating mb-3">
                            ...
                            <div class="mt-4 mb-0">
                                <div class="d-grid">
                                    <input class="btn btn-success btn-block" type="submit" value="Add Member" name="submit">
                                </div>
                        </form>
                    </div>
                </div>
