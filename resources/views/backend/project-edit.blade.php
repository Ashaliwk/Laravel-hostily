            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <a href="{{url('/admin/projects')}}"><button class="btn btn-success">Projects List</button></a></a>
                    </div>
                    <div class="card-body">
                        <form method="post" action="/admin/project-edit/{{$project->id}}" enctype="multipart/form-data">
                            ...
                            <div class="mt-4 mb-0">
                                <div class="d-grid">
                                    <input class="btn btn-success btn-block" type="submit" value="Update Project" name="submit">
                                </div>
                        </form>
                    </div>
                </div>
