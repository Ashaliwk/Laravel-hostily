    ...
    <div id="wrapper">
        <ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item {{ Request::is('admin/faqs', 'admin/faq-add') ? 'active':''}}">
                ...
                <div id="collapseFaqs" class="collapse" aria-labelledby="reviews" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
            ...
            <li class="nav-item {{ Request::is('admin/reviews', 'admin/review-add') ? 'active':''}}">
            ...
            <li class="nav-item {{ Request::is('admin/room', 'admin/room-add') ? 'active':''}}">
                ...
                <div id="collapseRooms" class="collapse" aria-labelledby="rooms" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{url('/admin/room')}}">Rooms details</a>
                        <a class="collapse-item" href="{{url('/admin/room-add')}}">Add Room Products</a>
                    </div>
                </div>
            </li>
